...
import { X, MessageCircle, Send, User, Mail, Phone, Package } from 'lucide-react'
import { useAuth } from '../context/AuthContext'
import customOrderService from '../services/customOrderService'

const CustomOrderModal = ({ isOpen, onClose, creator }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit order request to Firebase (optional - continue even if this fails)
      try {
        await customOrderService.submitCustomOrderRequest(orderData)
      } catch (firebaseError) {
        console.warn('Failed to save to Firebase, but continuing with WhatsApp:', firebaseError)
      }
      
      // Track analytics (optional - don't fail if this fails)
      try {
        await customOrderService.trackOrderRequest(orderData)
      } catch (analyticsError) {
        console.warn('Failed to track analytics:', analyticsError)
      }

      // Create WhatsApp message
      const message = customOrderService.formatCustomOrderMessage(formData, creator.name)
      
      // Generate WhatsApp URL
      const whatsappUrl = customOrderService.generateWhatsAppURL(creator.whatsapp, message)
